"""Build OMEGA v18 notebook: omega_v18_attack.ipynb"""
...
attack_src = (DIR / "omega_v18_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v18_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v18 (Multi-Harvest Baseline Breakthrough 91.350+) Validation")
print("=" * 60)
...
# v18 Exact v13 baseline checks
for pattern, desc in [
    ("PROBE_HOPS = 0", "v18 PROBE_HOPS = 0 (v13 exact)"),
    ("REPLAY_COST_COEF = 1.0", "v18 REPLAY_COST_COEF = 1.0 (STRICT 1:1)"),
    ("REPLAY_SAFE_FRAC = 0.994", "v18 REPLAY_SAFE_FRAC = 0.994 (v13 exact)"),
    ("SLOWEST_MULT = 1.10", "v18 SLOWEST_MULT = 1.10 (v13 exact)"),
    ("SPLIT_CLASSIFY_N = 1", "v18 SPLIT_CLASSIFY_N = 1 (v13 exact)"),
    ("SLOWEST0 = 12.0", "v18 SLOWEST0 = 12.0 (v13 exact)"),
    ("WARMUP_INDICES = [899999, 899998, 899997]", "v18 Multi-Harvest WARMUP_INDICES"),
    ("max_tool_hops=1", "Warm-up at hops=1"),
]:
    assert pattern in decoded, f"FAIL: {desc}"
    print(f"[OK] {desc}")

# v18 Exact v13 prompt wording check
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v18 notebook is ready!")
print("=" * 60)
