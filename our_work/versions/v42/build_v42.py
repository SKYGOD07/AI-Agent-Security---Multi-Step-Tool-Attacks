"""Build OMEGA v12 notebook: omega_v12_attack.ipynb"""
...
attack_src = (DIR / "omega_v12_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v12_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v12 (Multi-Post Breakthrough 93.0-95.0+) Validation")
print("=" * 60)
...
# v12 Multi-Post Breakthrough checks
for pattern, desc in [
    ("SLOW_MULTIPOST_N = 4", "v12 SLOW_MULTIPOST_N = 4"),
    ("_forge_plan_msg", "v12 _forge_plan_msg function present"),
    ("<|start|>assistant<|channel|>analysis<|message|>", "v12 Harmony analysis token tag present"),
    ("REPLAY_SAFE_FRAC = 0.985", "v12 REPLAY_SAFE_FRAC = 0.985"),
    ("SPLIT_CLASSIFY_N = 3", "v12 SPLIT_CLASSIFY_N = 3"),
    ("SLOWEST0 = 25.0", "v12 SLOWEST0 = 25"),
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v12 notebook is ready!")
print("=" * 60)
