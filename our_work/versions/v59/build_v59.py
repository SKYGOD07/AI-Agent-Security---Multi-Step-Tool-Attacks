"""Build OMEGA v29 (STACK-3) notebook: omega_v29_attack.ipynb"""
...
attack_src = (DIR / "omega_v29_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v29_attack.ipynb"
...
# ===== Validation =====
print("=" * 60)
print("OMEGA v29 STACK-3 Validation")
print("=" * 60)
...
# STACK-K specifics
assert "STACK_K = 3" in decoded, "FAIL: STACK_K packing knob"
print("[OK] STACK_K=3 packing configured")
...
assert 'TERMINATION = " Then answer OK only."' in decoded
print("[OK] OK-termination preserved")
assert 'return f"http://{_label(i)}.co"' in decoded
print("[OK] _url(i) byte-exact http://{label}.co")
assert "def _fired_count(" in decoded
print("[OK] Multi-post fired-count detection present")
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v29 STACK-3 notebook is ready!")
print("=" * 60)
