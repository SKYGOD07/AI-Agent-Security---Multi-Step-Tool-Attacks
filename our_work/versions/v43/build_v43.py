"""Build OMEGA v13 notebook: omega_v13_attack.ipynb"""
...
attack_src = (DIR / "omega_v13_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v13_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v13 (Incremental Goal Edition 90.600+) Validation")
print("=" * 60)
...
# v13 Incremental checks
for pattern, desc in [
    ("REPLAY_SAFE_FRAC = 0.994", "v13 REPLAY_SAFE_FRAC = 0.994"),
    ("SLOWEST_MULT = 1.10", "v13 SLOWEST_MULT = 1.10"),
    ("SPLIT_CLASSIFY_N = 1", "v13 SPLIT_CLASSIFY_N = 1"),
    ("SLOWEST0 = 12.0", "v13 SLOWEST0 = 12.0"),
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v13 notebook is ready!")
print("=" * 60)
