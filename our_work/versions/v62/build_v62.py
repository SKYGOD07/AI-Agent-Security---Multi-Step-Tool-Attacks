"""Build OMEGA v32 (MAXPACK) notebook: omega_v32_attack.ipynb"""
...
attack_src = (DIR / "omega_v32_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v32_attack.ipynb"
...
# ===== Validation =====
print("=" * 60)
print("OMEGA v32 MAXPACK Validation")
print("=" * 60)
...
# MAXPACK specifics
assert "MAX_K = 8" in decoded, "FAIL: MAX_K ceiling"
print("[OK] MAX_K=8 burst ceiling")
assert "COMPLIANCE_MIN = 0.85" in decoded, "FAIL: compliance gate"
print("[OK] Compliance gate (>=85% posts must fire)")
assert "def _choose_max_k(" in decoded, "FAIL: descending-K chooser"
print("[OK] Largest-compliant-K chooser present")
assert "for k in range(max_k, 0, -1):" in decoded
print("[OK] Descends from MAX_K, falls back to K=1 (v22 champion)")
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v32 MAXPACK notebook is ready!")
print("=" * 60)
