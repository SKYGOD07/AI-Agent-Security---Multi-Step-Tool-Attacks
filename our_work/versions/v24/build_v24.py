...
with open("our_work/jed_attack_decoded_v24.py", "r", encoding="utf-8") as f:
    attack_py = f.read()
    ...
    "cells": [
        {
            ...
            "metadata": {"tags": []},
            "source": [
                "# AI Agent Security \u2014 Multi-Step Tool Attacks \u00b7 **Submission notebook v24**\n",
                "\n",
                "**v24: 5-Template Fire-Rate Race with REPLAY_SAFE=0.99**\n",
                "\n",
                "Based on the proven JED relay architecture (v24 ancestor scored 87.9):\n",
...
# ---- Write the notebook ----
output_path = "our_work/notebooks/stockfish_v24_attack.ipynb"
...
print("v24 notebook created and validated!")
