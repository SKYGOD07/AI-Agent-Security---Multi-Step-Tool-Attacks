"""OMEGA v14 (v44) — Precision Squeeze Edition (Target 91.665+).

Builds directly on v13's confirmed 91.170 peak architecture.
Three surgical increments to extract +5-6 more candidates:

  1. REPLAY_SAFE_FRAC = 0.996 (8964s cap -> reclaims +18s of budget -> +2 candidates)
  2. SLOWEST_MULT = 1.05 (tighter end-of-fill cushion -> +1 candidate)
  3. REPLAY_COST_COEF = 0.97 (replay is slightly faster than fill since model
     is already warm during replay phase -> +2-3 candidates)

Calculated Yield: ~1018.5 candidates = 91.665+ score!
"""
...
# ---- Tuning Knobs (OMEGA v14 / v44 - Precision Squeeze Config) ----
MARGIN_S = 47.0
SLOWEST0 = 12.0                    # v13 proven value
SLOWEST_MULT = 1.05                # Tightened from 1.10 to 1.05
...
REPLAY_SAFE_FRAC = 0.996            # Expanded from 0.994 to 0.996 (8964s cap)

PROBE_HOPS = 0
REPLAY_COST_COEF = 0.97             # Replay slightly faster than fill (model warm)
...
class AttackAlgorithm(AttackAlgorithmBase):
    """OMEGA v14 Precision Squeeze Edition Attack Algorithm."""
