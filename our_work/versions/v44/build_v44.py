"""Build OMEGA v14 notebook: omega_v14_attack.ipynb"""
...
attack_src = (DIR / "omega_v14_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v14_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v14 (Precision Squeeze 91.665+) Validation")
print("=" * 60)
...
# v14 Precision Squeeze checks
for pattern, desc in [
    ("REPLAY_SAFE_FRAC = 0.996", "v14 REPLAY_SAFE_FRAC = 0.996"),
    ("SLOWEST_MULT = 1.05", "v14 SLOWEST_MULT = 1.05"),
    ("REPLAY_COST_COEF = 0.97", "v14 REPLAY_COST_COEF = 0.97"),
    ("SPLIT_CLASSIFY_N = 1", "v14 SPLIT_CLASSIFY_N = 1 (from v13)"),
    ("SLOWEST0 = 12.0", "v14 SLOWEST0 = 12.0 (from v13)"),
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v14 notebook is ready!")
print("=" * 60)
