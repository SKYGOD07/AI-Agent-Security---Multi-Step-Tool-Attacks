"""Build OMEGA v31 (TURBO) notebook: omega_v31_attack.ipynb"""
...
attack_src = (DIR / "omega_v31_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v31_attack.ipynb"
...
# ===== Validation =====
print("=" * 60)
print("OMEGA v31 TURBO Validation")
print("=" * 60)
...
# TURBO preserves v22 single-post champion byte-exact
...
# TURBO's single change: fast-row reseed, cushion UNCHANGED
assert "SLOWEST_MULT = 1.10" in decoded, "FAIL: cushion must stay 1.10 (not v28's 1.05)"
print("[OK] 1.10 cushion preserved (not tightened like v28)")
assert "RESEED_ENABLED = True" in decoded and "def _median(" in decoded
print("[OK] Fast-row reseed present with robust median")
assert "if reseed_on and not slow_row:" in decoded
print("[OK] Reseed is fast-row gated (slow row = exact v22 behavior)")
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v31 TURBO notebook is ready!")
print("=" * 60)
