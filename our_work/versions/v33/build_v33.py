"""Build OMEGA v3 notebook: omega_v3_attack.ipynb

Reads omega_v3_attack.py, base64-encodes it, and builds a 3-cell Kaggle
...
PROJECT_ROOT = DIR.parents[2]  # our_work/versions/v33 -> root

# Read attack source
attack_src = (DIR / "omega_v3_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v3_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v3 Notebook Validation")
print("=" * 60)
...
checks = [
    ...
    ("REPLAY_SAFE_FRAC = 0.98", "Uses 0.98 replay safety fraction"),
    ("SPLIT_CLASSIFY_N = 7", "Uses 7-sample classification"),
]
...
print("=" * 60)
print("ALL VALIDATIONS PASSED — OMEGA v3 notebook is ready!")
print("=" * 60)
