"""OMEGA v17 (v47) — Precision Squeeze Successor Edition (Target 91.359+).

Builds directly on v13's confirmed 91.170 peak architecture.
Restores 100% of v13's proven safety core:
  1. PROBE_HOPS = 0 (Exact 8-hop search latency measurement - ZERO under-estimation!)
  2. REPLAY_COST_COEF = 1.0 (STRICT 1:1 cost accounting - zero replay budget overflow!)
  3. EXACT v13 PROMPT WORDING (Proven 100% fire rate and instant termination)
  4. SPLIT_CLASSIFY_N = 1 (Fast 1-sample classification at 12.0s threshold)
  5. SLOWEST0 = 12.0 (Tight initial latency seed)

Applies 2 surgical precision increments over v13:
  - REPLAY_SAFE_FRAC = 0.995 (8955s cap -> reclaims +9s budget -> +1.1 candidates)
  - SLOWEST_MULT = 1.09 (tightens end-of-fill stop cushion -> +1.0 candidate)

Calculated Yield: ~1015.1 candidates = 91.359+ score!
"""
...
# ---- Tuning Knobs (OMEGA v17 / v47 - Precision Squeeze Successor Config) ----
MARGIN_S = 47.0
SLOWEST0 = 12.0                    # v13 proven value
SLOWEST_MULT = 1.09                # Tightened from 1.10 to 1.09 for +1 candidate
...
REPLAY_SAFE_FRAC = 0.995            # Expanded from 0.994 to 0.995 (8955s cap, 45s safety cushion)
...
class AttackAlgorithm(AttackAlgorithmBase):
    """OMEGA v17 Precision Squeeze Successor Attack Algorithm."""
