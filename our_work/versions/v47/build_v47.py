"""Build OMEGA v17 notebook: omega_v17_attack.ipynb"""
...
attack_src = (DIR / "omega_v17_attack.py").read_text(encoding="utf-8")
...
output_path = PROJECT_ROOT / "our_work" / "notebooks" / "omega_v17_attack.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)

# ===== Validation =====
print("=" * 60)
print("OMEGA v17 (Precision Squeeze Successor 91.359+) Validation")
print("=" * 60)
...
# v17 Precision Squeeze Successor checks
for pattern, desc in [
    ("PROBE_HOPS = 0", "v17 PROBE_HOPS = 0 (Exact 8-hop search latency)"),
    ("REPLAY_COST_COEF = 1.0", "v17 REPLAY_COST_COEF = 1.0 (STRICT 1:1)"),
    ("REPLAY_SAFE_FRAC = 0.995", "v17 REPLAY_SAFE_FRAC = 0.995 (8955s cap)"),
    ("SLOWEST_MULT = 1.09", "v17 SLOWEST_MULT = 1.09 (Tightened cushion)"),
    ("SPLIT_CLASSIFY_N = 1", "v17 SPLIT_CLASSIFY_N = 1 (v13 proven)"),
    ("SLOWEST0 = 12.0", "v17 SLOWEST0 = 12.0 (v13 proven)"),
...
# v17 Exact v13 prompt wording check
...
print("=" * 60)
print("ALL VALIDATIONS PASSED -- OMEGA v17 notebook is ready!")
print("=" * 60)
