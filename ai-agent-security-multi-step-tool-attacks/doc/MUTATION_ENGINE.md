...
4.  **Handoff Recipients**: Cycles through distinct recipient email addresses for confused deputy scenarios.

## Structural Chain Construction

Multi-step tool-use sequences are constructed using two main structures:
...
```
These structures force the agent to act as a confused deputy, transferring untrusted test vectors into local system tools.
